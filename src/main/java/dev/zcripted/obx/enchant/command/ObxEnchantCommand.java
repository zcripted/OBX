...
import dev.zcripted.obx.enchant.item.EnchantGuideBook;
 ...
 * {@link dev.zcripted.obx.enchant.gui.EnchantAdminMenu} once that phase
 * is wired in.
 */
public final class ObxEnchantCommand extends AbstractObxCommand implements TabCompleter {
    ...
    public ObxEnchantCommand(Main plugin) {
        super(plugin);
