 ...
 * dev.zcripted.obx.command.admin.PluginListCommand}) report: a blank
 * line, the {@code ▍ 𝗢𝗕𝗫 › …} title bar, a divider, the indented
 ...
 * (permission {@code obx.list}, default true). Console output routes through
 * OBX's ANSI console writer exactly like {@code /pl}.
 */
