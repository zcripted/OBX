...
public final class AdminSubMenu {
    ...
    private static void handleWorldBorderClick(Main plugin, Player player, int slot) {
    ...
    public static void openModulesMenu(Main plugin, Player player) {
    ...
    private static void handleModulesClick(Main plugin, Player player, int slot) {
    ...
    private enum ModuleEntry {
        ...
        void setEnabled(Main plugin, boolean value) {
            switch (this) {
                case CHAT:
    ...
    private static void writeModuleFlag(Main plugin, String relFile, String key, boolean value) {
