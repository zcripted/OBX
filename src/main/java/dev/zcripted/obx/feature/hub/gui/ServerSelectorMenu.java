...
public final class ServerSelectorMenu {
    ...
    private static void renderAndOpen(ObxPlugin plugin, Player player, HubService hub, BungeeMessenger messenger,
    ...
    private static ItemStack buildCloseButton(ObxPlugin plugin, Player player, HubService hub) {
    ...
    private static ItemStack buildServerIcon(ObxPlugin plugin, HubService hub, BungeeMessenger messenger,
