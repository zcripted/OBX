...
import dev.zcripted.obx.hologram.render.HologramRenderer;
import dev.zcripted.obx.hologram.render.TickLoop;
import dev.zcripted.obx.hologram.storage.HologramStorage;
import dev.zcripted.obx.hologram.storage.YamlHologramStorage;
 ...
 * backend selection — mirrors {@link dev.zcripted.obx.hub.HubService}
 * and {@link dev.zcripted.obx.chat.service.ChatService}.
 *
...
public final class HologramService {
    ...
    public void reload() {
        ...
        if (renderer != null) {
            ...
            for (dev.zcripted.obx.hologram.model.Hologram hologram : registry.all()) {
