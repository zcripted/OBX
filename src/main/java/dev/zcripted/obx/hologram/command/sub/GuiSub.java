...
public final class GuiSub implements HoloSubCommand {
    ...
    private final dev.zcripted.obx.hologram.gui.HologramEditorMenu menu;

    public GuiSub(HoloContext ctx, dev.zcripted.obx.hologram.gui.HologramEditorMenu menu) {
        this.ctx = ctx;
        this.menu = menu;
    }
