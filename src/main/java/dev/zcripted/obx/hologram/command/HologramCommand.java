...
import dev.zcripted.obx.hologram.command.sub.BackgroundSub;
import dev.zcripted.obx.hologram.command.sub.BillboardSub;
import dev.zcripted.obx.hologram.command.sub.BoardSub;
import dev.zcripted.obx.hologram.command.sub.CopySub;
import dev.zcripted.obx.hologram.command.sub.CreateSub;
import dev.zcripted.obx.hologram.command.sub.DeleteSub;
import dev.zcripted.obx.hologram.command.sub.DisableSub;
import dev.zcripted.obx.hologram.command.sub.DoubleSidedSub;
import dev.zcripted.obx.hologram.command.sub.EnableSub;
import dev.zcripted.obx.hologram.command.sub.GuiSub;
import dev.zcripted.obx.hologram.command.sub.HideSub;
import dev.zcripted.obx.hologram.command.sub.ShowSub;
import dev.zcripted.obx.hologram.command.sub.ViewSub;
import dev.zcripted.obx.hologram.command.sub.InfoSub;
import dev.zcripted.obx.hologram.command.sub.InteractSub;
import dev.zcripted.obx.hologram.command.sub.LineSub;
import dev.zcripted.obx.hologram.command.sub.ListSub;
import dev.zcripted.obx.hologram.command.sub.MoveHereSub;
import dev.zcripted.obx.hologram.command.sub.MoveSub;
import dev.zcripted.obx.hologram.command.sub.PageSub;
import dev.zcripted.obx.hologram.command.sub.ReloadSub;
import dev.zcripted.obx.hologram.command.sub.ScaleSub;
import dev.zcripted.obx.hologram.command.sub.SeethroughSub;
import dev.zcripted.obx.hologram.command.sub.ShadowSub;
import dev.zcripted.obx.hologram.command.sub.ShowRangeSub;
import dev.zcripted.obx.hologram.command.sub.TextAlphaSub;
import dev.zcripted.obx.hologram.command.sub.TpSub;
import dev.zcripted.obx.hologram.command.sub.UpdateRangeSub;
...
public final class HologramCommand extends AbstractObxCommand implements TabCompleter {
    ...
    private void sendHelp(CommandSender sender) {
        sender.sendMessage(dev.zcripted.obx.hologram.HoloMessages.header("subcommands"));
        sender.sendMessage(dev.zcripted.obx.hologram.HoloMessages.DIVIDER);
