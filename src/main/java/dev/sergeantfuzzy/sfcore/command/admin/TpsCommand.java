 ...
 * same content rendered to ANSI through SF-Core's existing console writer (no
...
public final class TpsCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!sender.hasPermission("sfcore.tps")) {
    ...
    private Map<String, String> buildPlaceholders(TpsService service) {
    ...
    private static String buildTpsTooltip(double tps, String color, String formatted, String window) {
        ...
        builder.append("&6TPS &8› &fPerformance");
        builder.append("\\n").append("&8──────────────────────────");
    ...
    private static String buildMsptTooltip(double mspt, String color, String formatted, boolean realProcessingTime) {
        ...
        if (realProcessingTime) {
            ...
            builder.append("&6MSPT &8› &fTick Time");
            builder.append("\\n").append("&8──────────────────────────");
            ...
            builder.append("&6MSPT &8› &fTick Drift");
            builder.append("\\n").append("&8──────────────────────────");
