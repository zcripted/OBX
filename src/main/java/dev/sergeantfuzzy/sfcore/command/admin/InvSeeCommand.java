...
import dev.sergeantfuzzy.sfcore.gui.admin.InvSeeMenu;
 ...
 * <ul>
 *   <li>{@code sfcore.invsee.basic} (level 1): allowed to view inventories of
 *   non-op players that don't themselves have any {@code sfcore.invsee.*} permission.</li>
 *   <li>{@code sfcore.invsee.full} (level 2): allowed to view <em>any</em>
...
public class InvSeeCommand implements CommandExecutor, TabCompleter {
    ...
    public static final String PERMISSION_BASIC = "sfcore.invsee.basic";
    public static final String PERMISSION_FULL = "sfcore.invsee.full";
     ...
     * they're an operator OR they hold any of the {@code sfcore.invsee.*}
