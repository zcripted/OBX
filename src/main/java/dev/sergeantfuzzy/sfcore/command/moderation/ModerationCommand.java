...
public class ModerationCommand implements CommandExecutor, TabCompleter {
    ...
    public enum Action {
        BAN("sfcore.moderation.ban", "player.moderation.usage.ban"),
        UNBAN("sfcore.moderation.unban", "player.moderation.usage.unban"),
        KICK("sfcore.moderation.kick", "player.moderation.usage.kick"),
        MUTE("sfcore.moderation.mute", "player.moderation.usage.mute"),
        UNMUTE("sfcore.moderation.unmute", "player.moderation.usage.unmute"),
        TEMPBAN("sfcore.moderation.tempban", "player.moderation.usage.tempban"),
        WARN("sfcore.moderation.warn", "player.moderation.usage.warn");
