...
import dev.sergeantfuzzy.sfcore.nickname.NicknameService;
...
public class NickCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        Player target;
        if (args.length >= 2) {
            if (!sender.hasPermission("sfcore.nick.others")) {
            ...
            if (!target.hasPermission("sfcore.nick")) {
        ...
        boolean allowColor = sender.hasPermission("sfcore.nick.color");
        if (!allowColor) {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (args.length == 2 && sender.hasPermission("sfcore.nick.others")) {
