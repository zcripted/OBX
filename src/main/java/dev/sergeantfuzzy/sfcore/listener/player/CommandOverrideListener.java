...
/**
 * Forces SF-Core's {@code /heal} and {@code /god} executors to run regardless of which plugin
...
public final class CommandOverrideListener implements Listener {
    ...
    /**
     * Maps every accepted alias (always lowercase) to the SF-Core plugin command name that
    ...
    static {
        ...
        for (String alias : Arrays.asList("heal", "bukkit:heal", "minecraft:heal", "essentials:heal", "sfcore:heal", "sf-core:heal")) {
            map.put(alias, "heal");
        }
        for (String alias : Arrays.asList("god", "gmode", "godmode", "invincible", "immortal",
                "bukkit:god", "minecraft:god", "essentials:god", "sfcore:god", "sf-core:god")) {
            map.put(alias, "god");
        }
        for (String alias : Arrays.asList("tps", "bukkit:tps", "minecraft:tps", "paper:tps",
                "purpur:tps", "spigot:tps", "essentials:tps", "sfcore:tps", "sf-core:tps")) {
            map.put(alias, "tps");
        }
        for (String alias : Arrays.asList("pl", "plugins", "bukkit:pl", "bukkit:plugins",
                ...
                "sfcore:pl", "sfcore:plugins", "sf-core:pl", "sf-core:plugins")) {
            map.put(alias, "pl");
        }
    ...
    private static final Set<String> KNOWN_NAMESPACES = new HashSet<>(Arrays.asList(
            "bukkit", "minecraft", "essentials", "sfcore", "sf-core", "paper", "purpur", "spigot"));
