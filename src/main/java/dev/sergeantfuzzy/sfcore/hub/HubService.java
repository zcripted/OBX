package dev.sergeantfuzzy.sfcore.hub;
 ...
 * {@link dev.sergeantfuzzy.sfcore.chat.service.ChatService} and
 * {@link dev.sergeantfuzzy.sfcore.tablist.service.TablistService} — typed
...
public final class HubService {
    ...
    public String selectorTitle() {
        if (config == null) {
            return "&6&lServer Selector";
        }
        return config.getString("selector.title", "&6&lServer Selector");
    }
