package dev.sergeantfuzzy.sfcore.hub.messaging;
...
public final class BungeeMessenger implements PluginMessageListener, Listener {
    ...
    public BungeeMessenger(Main plugin, HubService hubService) {
        this.plugin = plugin;
    ...
    /** Diagnostic helper used by /sf diagnostics integrations. */
