package dev.sergeantfuzzy.sfcore.scoreboard.scheduler;
 ...
 * stay current. Cancellable so a {@code /sf reload} (or a {@code systems/scoreboard.yml}
...
public final class ScoreboardRefreshTask {
    ...
    public ScoreboardRefreshTask(Main plugin, ScoreboardService service) {
        this.plugin = plugin;
