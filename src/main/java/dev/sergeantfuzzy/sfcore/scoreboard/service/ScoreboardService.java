package dev.sergeantfuzzy.sfcore.scoreboard.service;
 ...
 * {@code /sf reload} re-reads the file so title/lines/interval changes apply
 * live.
 */
public final class ScoreboardService {
    ...
    public String getServerIp() {
        if (config == null) {
            return "play.sf-core.com";
        }
        String value = config.getString("server-ip", "play.sf-core.com");
        return value == null ? "play.sf-core.com" : value;
    }

    public String getServerWebsite() {
        if (config == null) {
            return "www.sf-core.com";
        }
        String value = config.getString("server-website", "www.sf-core.com");
        return value == null ? "www.sf-core.com" : value;
    }
