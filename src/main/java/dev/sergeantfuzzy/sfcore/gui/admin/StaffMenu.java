...
import dev.sergeantfuzzy.sfcore.gui.shared.CustomHeadUtil;
...
import dev.sergeantfuzzy.sfcore.util.control.StaffSessionTracker;
...
public final class StaffMenu {
    ...
    private static ItemStack buildPlayerHead(Main plugin, Player viewer, LanguageRegistry registry,
        ...
        if (displayName == null || displayName.isEmpty()) {
            displayName = "§6§l" + subject.getName();
        }
