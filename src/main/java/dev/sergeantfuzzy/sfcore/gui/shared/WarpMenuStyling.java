package dev.sergeantfuzzy.sfcore.gui.shared;
...
public final class WarpMenuStyling {
    ...
    private static final String GRADIENT_START = "#FFD54A";
    private static final String GRADIENT_END = "#FFB300";
    ...
    private static String hexColor(String hex) {
        try {
            ...
            return color == null ? ChatColor.GOLD.toString() : color.toString();
        } catch (Exception ignored) {
