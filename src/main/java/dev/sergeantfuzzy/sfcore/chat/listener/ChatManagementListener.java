package dev.sergeantfuzzy.sfcore.chat.listener;

import dev.sergeantfuzzy.sfcore.Main;
import dev.sergeantfuzzy.sfcore.chat.format.ChatFormatter;
...
import dev.sergeantfuzzy.sfcore.util.message.ConsoleTimestamp;
...
public final class ChatManagementListener implements Listener {
    ...
    public ChatManagementListener(Main plugin, ChatService service) {
        this.plugin = plugin;
