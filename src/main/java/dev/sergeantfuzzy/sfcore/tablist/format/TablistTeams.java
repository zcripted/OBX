 ...
 * orders the player list by team name, so members of {@code sfcore.0staff}
 * always appear before members of {@code sfcore.1players} — staff are kept
...
public final class TablistTeams {
    ...
    private static final String STAFF_TEAM = "sfcore.0staff";
    private static final String PLAYER_TEAM = "sfcore.1players";
    ...
    /** Removes {@code player} from the SF-Core tablist teams (call on quit). */
    ...
    /** Unregisters the SF-Core tablist teams entirely (call on disable / when off). */
