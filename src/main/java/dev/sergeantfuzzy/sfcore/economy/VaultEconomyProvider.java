...
/**
 * Registers SF-Core's economy as a Vault provider — but only if the Vault plugin
...
public final class VaultEconomyProvider {
    ...
    public static boolean register(Main plugin, EconomyService economy) {
        ...
        try {
            ...
            plugin.getLogger().info("[SF-Core] Registered as Vault economy provider.");
            return true;
        } catch (Throwable throwable) {
            plugin.getLogger().warning("[SF-Core] Failed to register Vault economy provider: " + throwable.getMessage());
            return false;
        }
    }
    ...
    private static final class EconomyHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            switch (name) {
                ...
                case "toString": return "SF-Core EconomyProvider";
        ...
        private Object buildEconomyResponse(Class<?> returnType, double newBalance, double amount, String typeName, String errorMessage) {
            try {
                ...
                plugin.getLogger().warning("[SF-Core] Vault response construction failed: " + throwable.getMessage());
                return null;
            }
        }
    }
