package dev.sergeantfuzzy.sfcore.hologram.render;
...
import dev.sergeantfuzzy.sfcore.hologram.service.HologramRegistry;
    ...
    public void tick() {
        ...
        for (Hologram hologram : registry.all()) {
            ...
            if (!hologram.getLiveAnimations().isEmpty()) {
                ...
                for (dev.sergeantfuzzy.sfcore.hologram.anim.Animation anim : hologram.getLiveAnimations()) {
                    try {
