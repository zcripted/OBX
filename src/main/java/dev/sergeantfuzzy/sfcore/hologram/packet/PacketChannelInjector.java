package dev.sergeantfuzzy.sfcore.hologram.packet;
 ...
 * inserts the SF-Core hologram handler ahead of the vanilla
 * {@code packet_handler} sink. Removal mirrors the insertion path so quit
 * cleans up reliably.
 *
 * <p>The reflection chain (plan §6.1):
...
public final class PacketChannelInjector {
    ...
    private static final String HANDLER_NAME = "sfcore-holograms";
