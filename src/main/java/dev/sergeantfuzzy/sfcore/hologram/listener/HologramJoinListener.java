package dev.sergeantfuzzy.sfcore.hologram.listener;
...
public final class HologramJoinListener implements Listener {
    ...
    public void onQuit(PlayerQuitEvent event) {
        ...
        for (dev.sergeantfuzzy.sfcore.hologram.model.Hologram hologram : service.getRegistry().all()) {
        ...
        // starts on page 0.
        dev.sergeantfuzzy.sfcore.hologram.text.PageState.clear(uuid);
    }
}
