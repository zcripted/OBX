...
/**
 * Stable public API for plugins that want to drive SF-Core holograms
 ...
 * from the loaded SF-Core instance. Use the early-exit
 * {@link #isAvailable()} check before calling other methods so plugins
 * gracefully degrade when SF-Core is absent / disabled.
 */
public final class HologramFacade {
    ...
    public static HologramFacade get() {
        JavaPlugin loaded = (JavaPlugin) org.bukkit.Bukkit.getPluginManager().getPlugin("SF-Core");
