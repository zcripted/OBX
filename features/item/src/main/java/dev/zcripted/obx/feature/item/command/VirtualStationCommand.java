 ...
 */
public final class VirtualStationCommand extends AbstractObxCommand {

    /** One workstation: its inventory-type name, menu title, permission, and message-key prefix. */
    public enum Station {
        STONECUTTER("STONECUTTER", "Stonecutter", "obx.stonecut", "utility.stonecut"),
        LOOM("LOOM", "Loom", "obx.loom", "utility.loom"),
        GRINDSTONE("GRINDSTONE", "Grindstone", "obx.grindstone", "utility.grindstone"),
        CARTOGRAPHY("CARTOGRAPHY", "Cartography Table", "obx.cartography", "utility.cartography");
    ...
    public VirtualStationCommand(ObxPlugin plugin, Station station) {
        super(plugin);
