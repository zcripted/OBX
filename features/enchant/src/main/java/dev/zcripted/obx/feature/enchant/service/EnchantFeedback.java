...
public final class EnchantFeedback {
    ...
    public EnchantFeedback(ObxPlugin plugin) {
    ...
    public void send(Player player, ApplyResult result, ItemStack item) {
        ...
        if (result.getStatus() == ApplyStatus.UPGRADED) {
            ...
            dev.zcripted.obx.feature.enchant.util.Particles.burst(player.getEyeLocation(), dev.zcripted.obx.feature.enchant.util.Particles.MAGIC);
