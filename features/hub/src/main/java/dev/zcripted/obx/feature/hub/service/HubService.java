...
public final class HubService implements dev.zcripted.obx.api.hub.HubApi {
    ...
    public boolean isJumpRodEnabled() {
        return isItemEnabled(dev.zcripted.obx.feature.hub.item.HubItems.ID_JUMP_ROD);
    }

    public boolean isVanishAllEnabled() {
        return isItemEnabled(dev.zcripted.obx.feature.hub.item.HubItems.ID_VANISH_ALL);
    }

    public void openServerSelector(org.bukkit.entity.Player player) {
