package dev.zcripted.obx.feature.hub.command;
 ...
 * <ul>
 *   <li><b>Default players</b> (perm {@code obx.hub.use}) — bare command
 ...
 *   <li><b>Admins / ops</b> (perm {@code obx.hub.admin}) — full
 ...
 * </ul>
 */
public final class HubCommand extends AbstractObxCommand implements TabCompleter {
    ...
    public HubCommand(ObxPlugin plugin, HubService hub, HubKitApplier applier) {
        super(plugin);
        this.hub = hub;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        boolean isAdmin = sender.hasPermission("obx.hub.admin");
        ...
        if (!isAdmin) {
            if (!sender.hasPermission("obx.hub.use")) {
    ...
    private boolean handleMenu(CommandSender sender) {
        ...
        dev.zcripted.obx.feature.staff.gui.AdminSubMenu.openHubMenu(plugin, (Player) sender);
        return true;
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (!sender.hasPermission("obx.hub.admin")) {
