...
public final class HologramJoinListener implements Listener {
    ...
    public HologramJoinListener(ObxPlugin plugin, HologramService service) {
        this.plugin = plugin;
    ...
    public void onQuit(PlayerQuitEvent event) {
        ...
        for (dev.zcripted.obx.feature.hologram.model.Hologram hologram : service.getRegistry().all()) {
        ...
        // starts on page 0.
        dev.zcripted.obx.feature.hologram.text.PageState.clear(uuid);
    }
}
