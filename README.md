...
> Questions or want the API packaged as a standalone artifact? Reach out on [Discord](https://discord.gg/UxktSyT9Ag) or [zcripted.dev](https://zcripted.dev).

---

## 💬 Support & Community

- **Discord** — questions, help, and announcements: [discord.gg/UxktSyT9Ag](https://discord.gg/UxktSyT9Ag)
